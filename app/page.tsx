...
const principles = [
  {
    ...
    description:
      "Kami merancang pengalaman yang meminimalkan data dan menjaga ruang pribadi pengguna.",
    icon: <ShieldIcon />,
  },
  {
    title: "Empati & Respek",
    description:
      "AI hadir untuk membantu tanpa menghakimi, merendahkan, atau mengambil alih keputusan manusia.",
    icon: <HeartIcon />,
  },
  {
    title: "Aman & Bertanggung Jawab",
    description:
      "Teknologi digunakan secara transparan dengan batas yang jelas dan jalur bantuan manusia.",
    icon: <LockIcon />,
  },
  {
    title: "Akses untuk Semua",
    description:
      "AI seharusnya mudah dipahami dan berguna bagi lebih banyak masyarakat Indonesia.",
    icon: <UsersIcon />,
  },
];
...
const steps = [
  [
    "01",
    "Pilih layanan",
    "Pilih bantuan yang paling sesuai dengan kebutuhanmu.",
  ],
  [
    "02",
    "Ceritakan kebutuhan",
    "Sampaikan konteksmu dengan bahasa yang nyaman.",
  ],
  [
    "03",
    "Dapatkan dukungan AI",
    "AI membantu menyusun pilihan, langkah, atau dokumen.",
  ],
  [
    "04",
    "Kamu tetap memutuskan",
    "Keputusan akhir dan kendali selalu berada di tanganmu.",
  ],
];
      ...
      <section className="section section--compact" id="produk">
        <div className="container">
          <div className="section-heading">
            ...
            <p>
              Kita memulai dengan fokus, bukan dengan fitur yang berlebihan.
            </p>
          </div>
          ...
          <div className="product-grid">
            <article className="product-card product-card--blue">
              ...
              <div className="status-pill">Tersedia</div>

              <h3>Ruang Curhat</h3>

              <p className="product-card__tagline">
                Tempat bercerita tanpa dihakimi.
              </p>
      ...
      <section className="section" id="manifesto">
        <div className="container manifesto-panel">
          <div className="manifesto-copy">
            ...
            <h2>
              Teknologi yang memperkuat manusia, bukan mengambil alih manusia.
            </h2>
      ...
      <section className="section section--compact" id="tentang">
        <div className="container about-panel">
          ...
          <p>
            ...
            AI: dari sekadar mencari jawaban instan menjadi alat untuk
            memahami masalah, membangun kemampuan, dan mengambil keputusan
            dengan lebih sadar.
          </p>
        </div>
      </section>
      ...
      <section className="section" id="hubungi">
        <div className="container cta-panel">
          ...
          <div>
            ...
            <p>
              Diskusikan kolaborasi, masukan, atau pengembangan AI4IDN.
            </p>
          </div>
      ...
      <footer className="footer">
        <div className="container footer__grid">
          ...
          <div>
            ...
            <a href="mailto:alvitopranagian@gmail.com">
              Alvitopranagian@gmail.com
            </a>
